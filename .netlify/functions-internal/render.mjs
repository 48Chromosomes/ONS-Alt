	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/data-env/_server.ts.js'))
			},
			{
				id: "/api/geo",
				pattern: /^\/api\/geo\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/geo/_server.ts.js'))
			},
			{
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/health/_server.ts.js'))
			},
			{
				id: "/version",
				pattern: /^\/version\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/version/_server.ts.js'))
			},
			{
				id: "/(app)/[mode]",
				pattern: /^\/([^/]+?)\/?$/,
