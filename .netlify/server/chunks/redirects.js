...
const redirectIfNecessary = (url) => {
  ...
  if (url.pathname.includes("/identity/gender-identity")) {
    throw error(404, {
      ...
      readMoreLink: "https://www.ons.gov.uk/peoplepopulationandcommunity/culturalidentity/sexuality/methodologies/sexualorientationandgenderidentityqualityinformationforcensus2021"
    });
  }
};
const redirects = [
